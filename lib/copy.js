...
export const copy = {
  ...
  hero: {
    ...
    badge: "Uus retseptiraamat · 3200+ õpilast",
    headline: {
    ...
    subheadline:
      "Avasta 500 retsepti pehmete, kohevate ja maitsvate küpsetiste valmistamiseks – täiesti ilma gluteeni, piimatoodete ja suhkruta, et saaksid nautida igat suutäit ilma vaevuste, süütunde ja piiranguteta.",
    ctaLabel: "JAH, SOOVIN RAAMATUT",
    ...
    floatingBadges: {
      speed: { icon: "⏱️", top: "Valmib", bottom: "20 min" },
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "📖", title: "Samm-sammulised valmistamisjuhised" },
    ],
  },
  ...
  samples: {
    ...
    items: [
      ...
      {
        name: "RED VELVET EHK PUNANE SAMET KOOK",
        variant: "(TERVISLIK)",
        kcal: "105",
        time: "19 minutit",
  ...
  moreRecipesCta: {
    ...
    ctaLabel: "LAADI ALLA OMA EKSEMPLAR",
  },
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 TikToki kuulsat küpsetist",
        items: [
          { src: "/preview/1-7.webp", alt: "TikToki küpsetis 1" },
          { src: "/preview/2-6.webp", alt: "TikToki küpsetis 2" },
          { src: "/preview/3-5-1.webp", alt: "TikToki küpsetis 3" },
          { src: "/preview/4-3.webp", alt: "TikToki küpsetis 4" },
        ],
      },
      {
  ...
  bonuses: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "TERVISLIKE SÕÕRIKUTE RETSEPTID",
  ...
  finalCta: {
    ...
    headline: "MEISTERKOKK MAIE 500 KÜPSETISE RAAMAT ®",
    ...
    includes: [
      ...
      "+ KÜPSISTE JA MUFFINITE RETSEPTID",
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "🚫", text: "Ja ka tahvelarvutist." },
      { icon: "♾️", text: "Eluaegne ligipääs: Koos uute retseptidega." },
  ...
  guarantee: {
    kicker: "Riskivaba",
    headline: "PROOVI RISKIVABALT — 60-päevane tingimusteta garantii.",
    body: "Sul on 60 päeva aega neid katsetada. Kui retseptid sind ei veena, tagastan su raha viimase kui sendini. Ilma liigsete küsimusteta. Ilma stressita.",
    alt: "60-päevase tingimusteta garantii märk",
    image: { src: "/guarantee-badge.webp", alt: "60-päevane garantii" },
  },
